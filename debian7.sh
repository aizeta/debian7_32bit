...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/nifira123/debian7_32bit/naura/sources.list.debian7"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/nifira123/debian7_32bit/naura/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by Rizal Hidayat | 081515292117</pre>" > /home/vps/public_html/index.html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/nifira123/debian7_32bit/naura/vps.conf"
service nginx restart

# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/nifira123/debian7_32bit/naura/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/nifira123/debian7_32bit/naura/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
iptables -t nat -I POSTROUTING -s 192.168.100.0/24 -o eth0 -j MASQUERADE
iptables-save > /etc/iptables_yg_baru_dibikin.conf
wget -O /etc/network/if-up.d/iptables "https://raw.githubusercontent.com/nifira123/debian7_32bit/naura/iptables"
chmod +x /etc/network/if-up.d/iptables
service openvpn restart

#konfigurasi openvpn
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn "https://raw.githubusercontent.com/nifira123/debian7_32bit/naura/client-1194.conf"
...
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/nifira123/debian7_32bit/naura/badvpn-udpgw64"
fi
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/nifira123/debian7_32bit/naura/squid3.conf"
...
# download script
cd /usr/bin
wget -O menu "https://raw.githubusercontent.com/nifira123/debian7_32bit/naura/menu.sh"
...
wget -O member "https://raw.githubusercontent.com/nifira123/debian7_32bit/naura/user-list.sh"
wget -O resvis "https://raw.githubusercontent.com/nifira123/debian7_32bit/naura/resvis.sh"
wget -O speedtest "https://raw.githubusercontent.com/nifira123/debian7_32bit/naura/speedtest_cli.py"
wget -O info "https://raw.githubusercontent.com/nifira123/debian7_32bit/naura/info.sh"
wget -O about "https://raw.githubusercontent.com/nifira123/debian7_32bit/naura/about.sh"
